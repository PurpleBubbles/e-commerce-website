...
include '../controllers/seller_controllers/bought_productview_ctrl.php';
...
<body style="height: 100vh;">
    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/seller/product.php?product=<?php echo $product_id ?>" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                Product
            </a>
        </div>
    </div>
